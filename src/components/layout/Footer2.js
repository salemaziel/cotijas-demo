  ...
  return (
    <>
      <footer className="text-gray-600 body-font">
        <div className="w-full container flex flex-col flex-wrap px-5 py-24 mx-auto md:items-center lg:items-start md:flex-row md:flex-nowrap">
        ...
        <div className="bg-black">
          <div className="w-full container flex flex-col flex-wrap px-5 py-4 mx-auto sm:flex-row">
