...
import Logo from '../../images/cotijas-taco-shop-logo-noBG-square-250x.png';
import {
  FaFacebookF,
  FaEnvelope,
  FaYelp,
  ...
  return (
    <>
      <footer className="text-gray-600 body-font">
        <div className="w-full relative sm:max-w-screen-sm md:max-w-screen-md xl:max-w-screen-xl 2xl:max-w-screen-2xl  flex flex-col flex-wrap px-5 py-24 mx-auto md:items-center lg:items-start md:flex-row md:flex-nowrap">
          ...
          <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5" />
              ...
              <span className="ml-3 text-xl">Cotijas </span>
            </a>
        ...
        <div className="bg-black">
          <div className="w-full relative sm:max-w-screen-sm md:max-w-screen-md xl:max-w-screen-xl 2xl:max-w-screen-2xl  flex flex-col flex-wrap px-5 py-4 mx-auto sm:flex-row">
